      ...
      <div className="w-full h-auto flex flex-col">
            ...
            <div className="w-full sm:w-1/2 h-full flex justify-center place-self-center">
              <div className="flex flex-col gap-5">
                ...
                <p className="text-l lg:text-xl sm:text-sm font-light text-justify sm:text-left leading-normal  mb-5 md:mb-3">
                  We are strong supporters of Cryptocurrency, blockchain
                  technology and forex trading. We hope to contribute as much as
                  possible to keep the investment community alive and growing.
                  Our vision is to develop along with our clients and make us
                  the finest investment company. Our aim is to build a great
                  relationship with you by providing you top quality service.
                </p>
              </div>
            </div>

            <div className="w-full h-72 sm:w-3/5 sm:h-auto flex flex-col justify-center mb-8 sm:mb-0">
              <img src={img1} alt="" className="w-full rounded-xl shadow-lg" />
            </div>
          </div>
        </div>
        <Divider />
        <div className="items-center justify-center">
          ...
          <div className="w-full justify-center items-center mx-auto flex lg:flex-row lg:col-span-4 gap-5 md:col-span-2  flex-col">
            <TeamCard image={img1} name="Ryan Williams" title="CEO" />
            <TeamCard
              image={img1}
              name="Tom Wesley"
              title="Lead Investment Officer"
            />
            <TeamCard image={img1} name="Alexander Jeffrey" title="CTO" />
          </div>
        </div>
      </div>
    </div>
