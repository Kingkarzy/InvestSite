  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-start gap-3">
        <h1 className="dark:text-black font-bold text-3xl mt-4">
          Send a message.
        </h1>
        <p className="dark:text-black mb-5 text-xl font-normal text-left">
          We always open to hearing your questions
        </p>
        <div className="flex justify-start items-center gap-12 w-full">
          <div className="flex flex-col">
            <p className="text-sm font-light dark:text-black">Mail us at</p>
            <p className="text-base font-normal dark:text-black">
              support@goobull.com
            </p>
          </div>
          <div className="flex flex-col">
            <p className="text-sm font-light dark:text-black">Talk to us on</p>
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-black text-sm font-light mt-5">Location </h2>
