...
const Testimonials = () => {
  ...
  return (
    <div className="flex w-full flex-col overflow-hidden justify-center items-center pb-8 text-black">
      <div>
        <h1 className="text-4xl font-semibold -mb-10">Testimonials</h1>
      </div>
      <div
      ...
      >
        {testimonials.map((item) => (
          <div key={item.id} className="flex-shrink-0 w-full min-h-90vh">
            <div className="flex-1 justify-center flex items-center ">
              <div className="p-12 flex items-center justify-center flex-col w-5/12 max-w-full md:w-8/12">
                <div className="p-8 flex flex-col bg-slate-100 justify-center shadow-3xl rounded">
                  ...
                  />
                  <div>
                    <p className="text-xl font-light mb-8">{item.review}</p>
                    <div className="flex justify-between items-center">
                      <div>
                        <h1 className="text-lg font-bold">{item.name}</h1>
                        <p className="text-base font-light italic text-[#4182AB]">
                          –{item.title}
                        </p>
                      </div>
