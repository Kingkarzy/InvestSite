...
const Header = () => {
  ...
  return (
    <div className="h-[67vh] lg:h-[90vh] xs:mt-5 lg:mt-0">
      <Swiper
        spaceBetween={30}
        // slidesPerView={1}
        loop={true}
      ...
      >
        <SwiperSlide>
          <div className="relative h-full w-full bg-pink-400">
            ...
            />
            <div className="absolute py-5 top-0 mt-10 lg:mt-0 lg:left-20 grid grid-cols-2 gap-5 items-center justify-center text-white">
        ...
        <SwiperSlide>
          <div className="relative h-full w-full">
            <img
              ...
              alt="Background Image"
            />
            <div className="absolute py-5 top-10 sm:mt-10 lg:left-20 grid grid-cols-2 gap-3 items-center justify-center ">
              <div className="p-5 text-left rounded-md shadow-sm">
