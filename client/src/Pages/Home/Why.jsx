...
const Why = () => {
  return (
    <div className='bg-bg p-12 w-full'>
            ...
            <div className='flex flex-row mb-14 w-2/3 border-solid border-2 rounded-md border-purple-500 p-4'>
              ...
              <div>
                ...
                <p className='text-sm lg:text-base text-white'>
                  Investment Trading has a user-friendly and
                  intelligible interface so that you can make the most
                  of our investment platform without any hassle.
                </p>
              </div>
            </div>
          </ScrollAnimation>
            ...
            <div className='flex flex-row mb-14 w-2/3 border-solid border-2 rounded-md border-green-400 p-4'>
              ...
              <div>
                ...
                <p className='text-sm lg:text-base text-white'>
                  ...
                  cryptocurrency & forex trading and use flexible
                  strategies to generate maximum profits.
                </p>
              </div>
            </div>
          </ScrollAnimation>
          ...
          >
            <div className='flex flex-row mb-14 w-2/3 border-solid border-2 rounded-md border-orange-400 p-4'>
              ...
              <div>
                ...
                <p className='text-sm lg:text-base text-white'>
                  Our site is within a dedicated & DDOS protected
                  server.
                </p>
              </div>
            </div>
