        ...
        <div className="navbar-container">
          ...
          <ul className={click ? "nav-menu active" : "nav-menu"}>
            ...
            <li className="nav-item flex items-center justify-center">
              <NavLink to="/login" className="" onClick={closeMobileMenu}>
                <button className="text-base px-10 lg:mr-2 font-medium hover:border-transparent border  hover:border-indigo-450 bg-black  text-white hover:text-black hover:scale-110 hover:bg-yellow-450">
                  Login
                </button>
              </NavLink>
            </li>
            <li className="nav-item flex items-center justify-center">
              <NavLink to="/register" className="" onClick={closeMobileMenu}>
